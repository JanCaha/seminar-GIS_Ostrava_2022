...
class WorkshopAlgorithm6(QgsProcessingAlgorithm):
    ...
    def createInstance(self):
        return WorkshopAlgorithm6()

    def name(self):
        return "workshop6"

    def displayName(self):
        return "Ukázka workshop 6"
    ...
    def shortHelpString(self):
        ...
        help = [
            ...
            "Prior to calculation, multipart geometries are divided into single ones.",
            "Output is rendedred using specific renderer."
        ]
    ...
    def processAlgorithm(self, parameters, context: QgsProcessingContext,
        ...
        params = {"INPUT": source, "OUTPUT": "TEMPORARY_OUTPUT"}
        ...
        source: QgsVectorLayer = result["OUTPUT"]

        feedback.pushInfo("Dividing of multipart data finished. Algorithm continues ...")
